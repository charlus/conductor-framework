...
- Self-test: `bash templates/.agents/tests/check-conductor.sh` → 113 checks; unit tests: `npm run test:unit` (`node:test`, 67 cases — loop backend + cross-version upgrade; no agent CLI spawned)

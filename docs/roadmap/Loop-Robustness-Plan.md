...
> **Remaining:** **P1.4** merge-conflict/resume discipline, **P2** (self-improvement loop, architecture-checklist contract, multi-engine parity), and real-run hardening of the fleet (it's exercised via dry-run + fake-agent smoke; needs mileage on live tickets under L3+sandbox).

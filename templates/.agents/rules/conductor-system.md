...
| "Ship it", "Audit and ship", "Release" | **Shipping** | → Ship workflow (`.agents/workflows/Ship.md`) |
...
- *"How does this framework work?"* → Invoke the **Conductor Assistant** persona, .
...
| **Ship** | "Ship it", "Audit and ship" | Polished code, tests, CI | Retrospective |
